...
export const ELEMENT_DEFINITIONS: ElementDefinition[] = [
  ...
  // Elementos de Confiança
  {
    ...
    defaultContent: {
      ...
      bgColor: "",
      items: [
        { icon: "Truck", title: "Frete Grátis", description: "Para todo o Brasil em compras acima de R$ 199" },
        { icon: "Shield", title: "Compra Segura", description: "Seus dados protegidos e pagamento seguro" },
        { icon: "Clock", title: "Entrega Rápida", description: "Enviamos em até 24 horas após a confirmação" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    defaultContent: {
      ...
      reviewTextSize: "sm",
      avatars: [
        "https://images.pexels.com/photos/708440/pexels-photo-708440.jpeg?auto=compress&cs=tinysrgb&w=100",
        "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=100",
        "https://images.pexels.com/photos/5686452/pexels-photo-5686452.jpeg?auto=compress&cs=tinysrgb&w=100",
      ],
      starColor: "#FACC15",
      textColor: "",
      bgColor: "",
