...
export const PixIcon = ({ size = 20 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M393.8 353.8c-26.2 0-51.1-10.2-69.7-28.8l-68.3-68.3-68.3 68.3c-18.6 18.6-43.5 28.8-69.7 28.8h-14.6l86.5 86.5c37.5 37.5 98.3 37.5 135.8 0l86.5-86.5h-18.2z" fill="#32BCAD"/>
    <path d="M117.8 158.2c26.2 0 51.1 10.2 69.7 28.8l68.3 68.3 68.3-68.3c18.6-18.6 43.5-28.8 69.7-28.8h18.2l-86.5-86.5c-37.5-37.5-98.3-37.5-135.8 0l-86.5 86.5h14.6z" fill="#32BCAD"/>
    <path d="M440.3 209.5l-46.5-46.5c-1.6.5-3.3.8-5 .8h-18.2c-19.6 0-38.3 7.8-52.1 21.6l-68.3 68.3c-5.5 5.5-12.7 8.2-19.9 8.2s-14.4-2.7-19.9-8.2l-68.3-68.3c-13.8-13.8-32.5-21.6-52.1-21.6h-14.6c-1.7 0-3.4-.3-5-.8l-46.5 46.5c-37.5 37.5-37.5 98.3 0 135.8l46.5 46.5c1.6-.5 3.3-.8 5-.8h14.6c19.6 0 38.3-7.8 52.1-21.6l68.3-68.3c10.6-10.6 29.2-10.6 39.8 0l68.3 68.3c13.8 13.8 32.5 21.6 52.1 21.6h18.2c1.7 0 3.4.3 5 .8l46.5-46.5c37.5-37.5 37.5-98.3 0-135.8z" fill="#32BCAD"/>
  </svg>
);
