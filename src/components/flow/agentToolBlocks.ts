...
export const AGENT_TOOL_BLOCKS: AgentToolBlock[] = [
  ...
  { category: "Conhecimento", toolName: "entregaveis", label: "Entregáveis", description: "Envia os conteúdos (vídeo, foto, documento, texto) após o pagamento ser confirmado", icon: PackageCheck, instructions: "Use IMEDIATAMENTE após confirmar que o pagamento do lead foi aprovado. Envie todos os entregáveis configurados (vídeos, fotos, documentos, áudios e textos) na ordem definida, com legendas/instruções apropriadas. Confirme com o lead se recebeu tudo e ofereça suporte para acessar o conteúdo." },
