  ...
  return (
    <div className={cn(
      ...
      <div className="min-w-0 flex-1">
          <p className="font-nunito text-[12px] tracking-wider text-white/40 font-normal [[data-theme='white']_&]:text-[#6B7280]">{title}</p>
         <p className="font-bebas text-[36px] text-white leading-none mt-0.5 tracking-wide [[data-theme='white']_&]:text-[#111827]">{value}</p>
        {subtitle && (
           <p className="font-nunito text-[11px] text-white/30 mt-1 [[data-theme='white']_&]:text-[#6B7280]">{subtitle}</p>
        )}
      </div>
    </div>
  );
