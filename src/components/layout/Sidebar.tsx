  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        <LogoImage className="w-full h-auto object-contain shrink-0 scale-110 translate-x-2 drop-shadow-[0_4px_12px_rgba(0,0,0,0.6)] transition-all duration-300 sidebar-logo" />
      </div>
