...
const zapiMenuItems = [
  ...
  { id: "extrair-membros", label: "Extrair Membros", icon: UserPlus, path: "/criar-grupos#participantes" },
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        <LogoImage className="w-full h-auto object-contain shrink-0 scale-110 translate-x-2 transition-all duration-300 sidebar-logo" />
      </div>
