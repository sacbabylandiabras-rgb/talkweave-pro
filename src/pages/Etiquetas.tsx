...
const Etiquetas = () => {
  ...
  const handleCreateTag = async () => {
    // Função desativada - apenas sincronização permitida
    toast({ title: "Ação não permitida", description: "A criação de etiquetas deve ser feita diretamente no WhatsApp Business." });
