...
const EnviarMensagem = () => {
  ...
  const { sendMessage, sendSticker, sendPoll, sendButtonActions, sendOptionList, sendImage, sendVideo, sendAudio, sendDocument, sendSpecialTemplate, sendCarousel, loading } = useZapi();
