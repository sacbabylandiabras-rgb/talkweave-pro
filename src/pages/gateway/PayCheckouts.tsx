                        ...
                        <div className="flex gap-1">
                          ...
                          {savedDomain && (
                            <Button
                              ...
                              onClick={() => {
                                const customLink = `https://${savedDomain}/pay/${ck.slug || ck.id}`;
                          ...
                          <Button
                            ...
                            size="icon"
                            className="h-7 w-7"
                            title={savedDomain ? "Copiar link padrão" : "Copiar link"}
                            onClick={() => {
                              const defaultLink = `https://pay.zaplynxpro.online/pay/${ck.slug || ck.id}`;
                              navigator.clipboard.writeText(defaultLink);
                              toast.success(savedDomain ? "Link padrão copiado!" : "Link copiado!");
                            }}
