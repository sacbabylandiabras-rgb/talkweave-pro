...
const TelegramRedirecionadores = lazyWithRecovery(() => import("./pages/telegram/TelegramRedirecionadores"));
const FluxoTelegram = lazyWithRecovery(() => import("./pages/FluxoTelegram"));
const TelegramModelos = lazyWithRecovery(() => import("./pages/telegram/TelegramModelos"));
               ...
               {isNative ? (
                 ...
                 <Route path="/login" element={<Auth />} />
                  <Route path="/reset-password" element={<ResetPassword />} />
                   ...
                   <Route path="/exclusao-dados" element={<ExclusaoDados />} />
                    <Route path="/integracao-loja/precos" element={<ShopifyPricing />} />
                ...
                <Route element={<AuthGuard><DashboardLayout /></AuthGuard>}>
                  ...
                  <Route path="/enviar" element={<EnviarMensagem />} />
                   ...
                   <Route path="/mensagens-recebidas" element={<MensagensRecebidas mode="chat" />} />
                  ...
                  <Route path="/afiliados" element={<PaidRouteGuard><Afiliados /></PaidRouteGuard>} />
