...
<!DOCTYPE html> <html lang="pt-BR"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Zaplynx - Convite</title> </head> <body style="margin: 0; padding: 20px; font-family: Arial, sans-serif; background-color: #f5f5f5;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="text-align: center;">
                        <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 50 50' width='50' height='50'%3E%3Crect x='5' y='5' width='40' height='40' rx='10' fill='%23c878ff'/%3E%3Ctext x='25' y='35' font-size='28' font-weight='bold' fill='white' text-anchor='middle'%3E⚡%3C/text%3E%3C/svg%3E" alt="Zaplynx" style="width: 50px; height: 50px; margin-right: 12px; vertical-align: middle; display: inline-block;">
    ...
    <tr>
        <td style="background-color: #1a1a2e; padding: 40px 30px; color: #ffffff;">
            ...
            <p style="margin: 0 0 30px 0; font-size: 16px; color: #b0b0b0; line-height: 1.6;">
                Você foi convidado para criar uma conta na plataforma Zaplynx por {{OWNER_EMAIL}} para a equipe {{TEAM_NAME}}.
            </p>
