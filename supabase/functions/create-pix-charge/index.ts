     ...
     await fetch(`${Deno.env.get('SUPABASE_URL')}/functions/v1/send-push-notification`, {
       ...
       body: JSON.stringify({
         ...
         body: `${customerName || 'Um cliente'} gerou um PIX de ${amountFormatted}`,
          data: { transaction_id: txRecord?.id, type: 'pix_generated', url: 'https://zaplynx.com/notificacoes-realtime' },
          url: 'https://zaplynx.com/notificacoes-realtime',
    ...
    try {
      ...
      const pushRes = await fetch(`${Deno.env.get('SUPABASE_URL')}/functions/v1/send-push-notification`, {
        ...
        body: JSON.stringify({
          ...
          data: { type: 'pix_generated', amount: String(amountCents), customer: customerName || '', url: 'https://zaplynx.com/notificacoes-realtime' },
          url: 'https://zaplynx.com/notificacoes-realtime',
          event_type: 'pix_or_boleto_issued',
          checkout_id: checkout.id,
        }),
