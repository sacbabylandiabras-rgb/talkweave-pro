...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
  ...
  <tr><td style="padding:30px">
    ...
    <p style="color:#64748b;font-size:14px;margin:0 0 25px">Seu PIX foi gerado com sucesso! Efetue o pagamento para concluir sua compra.</p>
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border-radius:8px;padding:20px;margin-bottom:25px">
      <tr><td>
        ...
        <p style="color:#64748b;font-size:12px;margin:0 0 4px">Valor</p>
        <p style="color:#ef4444;font-size:24px;font-weight:bold;margin:0">${amount}</p>
      </td></tr>
    </table>
    ${data.brCode ? `<p style="color:#64748b;font-size:12px;margin:0 0 8px">Código PIX (Copia e Cola):</p>
    <div style="background:#f1f5f9;border:1px solid #e2e8f0;border-radius:6px;padding:12px;word-break:break-all;font-size:11px;color:#334155;margin-bottom:25px">${data.brCode}</div>` : ''}
    <p style="color:#94a3b8;font-size:12px;margin:0;text-align:center">Após o pagamento, você receberá a confirmação por email.</p>
  </td></tr>
