...
DROP POLICY IF EXISTS "warmup_instance_health admins manage" ON public.warmup_instance_health;
...
DROP TRIGGER IF EXISTS warmup_instance_health_set_updated ON public.warmup_instance_health;
